...
public class CrawlPage {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.get("https://www.vskills.in/practice/selenium-mock-test"); 
		...
		FileOutputStream out = new FileOutputStream(new File("C:\\Training\\vskills_questions.docx"));
		...
		for(int page=0; page<(FETCHCOUNT/50); page++) {
			...
			if(elements.size()==50) {
				System.out.println("All 50 questions found on page: "+(page+1));
			}
			else {
